...
export default function PricingScreen() {
  ...
  const handleSkip = () => router.push('/afterauthhomepage');
  const handleSubscribe = () => router.push('/billing');
  ...
  return (
    <ScrollView style={styles.scroll} contentContainerStyle={styles.container}>
      ...
      <View style={styles.logoContainer}>
        <Image source={require('../../assets/asana logo.png')} style={styles.logo} />
        <Text style={styles.logoText}>Asana</Text>
      </View>
      ...
      <View style={styles.faqRow}>
        ...
        <TouchableOpacity style={styles.chatButton} onPress={() => router.push('/contact')}>
